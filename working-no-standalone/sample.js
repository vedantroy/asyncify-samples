...
// {{PRE_LIBRARY}}
  ...
  /** @type {function(...*):?} */
  function _async_sleep(
  ) {
  err('missing function: async_sleep'); abort(-1);
  }
  ...
  function runAndAbortIfError(func) {
      try {
        ...
        var ASYNCIFY_IMPORTS = ["env.async_sleep","env.invoke_*","env.emscripten_sleep","env.emscripten_wget","env.emscripten_wget_data","env.emscripten_idb_load","env.emscripten_idb_store","env.emscripten_idb_delete","env.emscripten_idb_exists","env.emscripten_idb_load_blob","env.emscripten_idb_store_blob","env.SDL_Delay","env.emscripten_scan_registers","env.emscripten_lazy_load_code","env.emscripten_fiber_swap","wasi_snapshot_preview1.fd_sync","env.__wasi_fd_sync","env._emval_await"].map(function(x) {
          return x.split('.')[1];
        });
...
var asmLibraryArg = { "__indirect_function_table": wasmTable, "async_sleep": _async_sleep, "emscripten_resize_heap": _emscripten_resize_heap, "memory": wasmMemory };
